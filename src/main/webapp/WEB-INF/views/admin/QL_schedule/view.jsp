			...
			<div class="row">
				...
				<div class="card">
					<div class="card-body">
						...
						<%-- <a
							href="<c:url value='/admin/QL_schedule/schedules/edit/${schedule.id}'/>">Sửa</a>
						|
						<form
							action="<c:url value='/admin/QL_schedule/schedules/delete/${schedule.id}'/>"
							method="post" style="display: inline;">
							<button type="submit">Xóa</button>
						</form> --%>
						<a class="btn btn-primary text-white"
							style="text-decoration: none;"
							href="<c:url value='/admin/schedules'/>">Quay lại
							danh sách</a>
					</div>
				</div>
			</div>
